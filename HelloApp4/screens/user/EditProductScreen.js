...
import { View, Text, TextInput, StyleSheet, ScrollView, Alert, KeyboardAvoidingView, ActivityIndicator } from 'react-native';
...
const formReducer = (state, action) => {
    if (action.type === FORM_INPUT_UPDATE) {
        ...
        return {
            ...
            inputValdities: updatedValidities,
            ...
            <ScrollView>
                <View style={styles.form}>
                    ...
                    <Input
                        id="description"
                        label="Description"
                        errorText="Please enter a valid description ( >= 5 letters)"
                        keyboardType="default"
                        onInputChange={inputChangedHandler}
                        autoCapitalize="sentences"
                        autoCorrect
